          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-xl leading-relaxed">
                I'm a passionate <span className="text-primary font-semibold">.NET Developer</span> with 1.6+ years of experience in building scalable web applications and backend systems using ASP.NET MVC/Core, SQL Server, and C#.
              </p>
            </div>
